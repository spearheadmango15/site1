      ...
      <main className="bg-mist text-deepPurple px-4 pt-20 pb-24 min-h-screen">
        ...
        <ScrollFade delay={0.3}>
          <section className="mt-24 text-center">
            <h2 className="text-3xl font-serif mb-8">Why Soulful Tarot?</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
              {['✨ Personalized Insights', '💫 Holistic Healing', '🔮 Safe Sacred Space'].map((txt, idx) => (
                <div key={idx} className="p-6 rounded-xl shadow-md bg-white/60 hover:scale-105 transition-transform duration-300">
